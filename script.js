...
const aboutMeTextContent =
  'Mr. McCoy is a graduate of Troy University, where he obtained his B.S. degree in Criminal Justice. Mr. McCoy has approximately (4) years of experience as a SQL/ETL Developer. Mr. McCoy is knowledgeable in T-SQL, and have some experience in SSRS, Tableau, PostgreSQL w/ Valentina Studio, HTML5, CSS3 & JavaScript. Mr. McCoy is ambitious and energetic with a solid history of achievements in Law Enforcement. Mr. McCoy is a motivated leader with strong organizational and prioritization abilities; as well as, multitasking, good customer and personal service skills, great attention to detail, stressful environments extremely well.';
